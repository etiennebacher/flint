...
test_that("fix works", {
  ...
  expect_snapshot(fix_text("expect_equal(typeof(x), 'double')", linters = linter))
  expect_snapshot(fix_text("expect_equal(typeof(x), \"double\")", linters = linter))

  expect_snapshot(fix_text("expect_identical(typeof(x), 'double')", linters = linter))
  expect_snapshot(fix_text("expect_identical(typeof(x), \"double\")", linters = linter))

  expect_snapshot(fix_text("expect_equal('double', typeof(x))", linters = linter))
  expect_snapshot(fix_text("expect_identical('double', typeof(x))", linters = linter))
